...
const SECTIONS_LIST = ['Aliya', 'Foundation', 'General', 'Foundation General']
                ...
                filteredEvents.map((event) => (
                  <TableRow key={event.id} className="group hover:bg-blue-50/30 transition-colors">
                    ...
                    <TableCell className="text-center">
                      <Badge className={`h-5 min-w-5 justify-center px-1 text-[10px] pointer-events-none ${event.grade_type === 'A' ? 'bg-amber-100 text-amber-800 hover:bg-amber-100 border-amber-200' :
